...
\begin{tabular}{p{0.03cm} p{9.2cm} p{7.0cm}}
\toprule
& \textbf{Criteria and Description} & \textbf{Taxonomy} \\
\midrule

\multirow[c]{7}{*}{\rotatebox[origin=c]{90}{\parbox{2.5cm}{\centering\textbf{Techniques}}}}
 & \textbf{Tracked Artifacts}: What artifacts are used to track users using this technique? & see Table~\ref{tab:} \\
 ...
 & \textbf{Tracker Goals}: What are goals of the tracker employing this tracking? & Same-site, Cross-site, Cross-device \\
 & \textbf{Tracker Capabilities}: What capabilities are required to use this technique? & \symInclusion\ Inclusion, \symExecution\ Execution, \symObservation\ Observation, \symStorage\ Storage, \symSharing\ Sharing \\
...
\multirow[c]{6}{*}{\rotatebox[origin=c]{90}{\parbox{2.2cm}{\centering\textbf{Defenses}}}}
 & \textbf{Tracking technique}: What tracking does this defense protect against? & see Table~\ref{tab:} \\
 ...
 & \textbf{Defense Deployment}: How can or is this defense deployed? & \dNative\ in-browser, \dExt\ extension, \dTool\ offline, \dServer\ infrastructural \\  % server-/network-/protocol-/OS-level
 & \textbf{Defense Support}: What is support for this and related practically deployed defenses? & see Figure~\ref{fig:} for browser-specific support \\
