...
Under stateless tracking (see \autoref{tab:appendix-stateless-tracking} in Appendix), trackers do not rely on a stored state (\ie{}, ID) in the browser to track a user, and instead collect artifacts of the user's behavior, browser, or hardware to generate a fingerprint to correlate a user across sites and sessions.
% 
...
%
% \autoref{tab:appendix-stateless-tracking} in Appendix summarizes different mechanisms and defenses.
