...
%%
Next, we describe the enactment and evolution of privacy regulations over the years, while many countries worldwide have their own data protection laws (LGPD in Brazil, DPDPA in India, Data Protection Act in the U.K., etc.)\footnote{for more see \url{https://www.cnil.fr/en/data-protection-around-the-world}}, we narrow down our focus on the EU and the US. An overview of technical and regulatory changes is provided in \autoref{fig:timeline}.
