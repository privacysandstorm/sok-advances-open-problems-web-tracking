...
%
Each paper was assigned one or more topics related to web tracking based on the abstract of the paper\footnote{The thematic organization is available at \url{https://osf.io/zsy7e/overview?view_only=a346b98bf89244b5b17d842f6fb3fb13}}.
%
...
%
Next, we present a unified threat model of web tracking in \autoref{sec:threat-model}. \autoref{sec:stateful-tracking} and \autoref{sec:stateless-tracking} discuss evolution of stateful and stateless tracking, respectively. 
%
