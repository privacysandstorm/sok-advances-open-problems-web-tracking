...
%
Modern browsers also group related origins into a broader notion of ``site'' based on the effective top-level domain plus one (eTLD+1)~\cite{TrackingPreventionWebKit2020} using public suffix lists\footnote{\eg{}, \url{https://publicsuffix.org/}}.
%
