...
%
These resources are either hosted on the web server of the site directly visited by the user (\ie{}, \textit{first-party}) or on other websites (\ie{}, \textit{third-party}).
%
...
%
Thus, JavaScript cookies can be accessed (\eg{}, using \texttt{document.cookie} or CookieStore API) by any script running in the same execution context regardless of its source. 
%
