...
%
% To realize these objectives, user tracking became a pervasive part of the web.
%%
...
%
Most survey papers have either been too high-level~\cite{ermakova2018web}, too narrowly-focused on specific forms of web tracking such as caching and browser fingerprinting~\cite{bujlowSurveyWebTracking2017,laperdrix2020browser}, or are not current with modern techniques anymore~\cite{mayerThirdPartyWebTracking2012}
%
...
At the same time, advertising paradigms that do not rely on cross-site tracking have been introduced and are being discussed for standardization at the W3C~\cite{chavezUpdatePlansPrivacy2025, hercherW3CAdPrivacy2022}.
%
...
%%
To this end, we synthesize the disparate lines of research and practices in web tracking---spanning across technical mechanisms, browser mitigations, as well as regulatory changes---to systematically provide an overview of the current state of web tracking. 
%
