...
%
Ever since the introduction of cookies on the web in mid-1990s, web tracking has also evolved into a significantly more pervasive and sophisticated practice.
%
Nowadays, user tracking and profiling often involves collection of user's personal details (such as name, email, and location), device characteristics (such as device model and operating system), browsing history, and behavioral signals (such as time spent on a page and performed interactions).
...
%
Although regulatory changes have had a more gradual impact than browser-based technical interventions, together they have continued to reshape the ecosystem.
%
Today, web tracking is undergoing a transformative change due to the introduction of privacy-enhancing protections in major web browsers, new advertising paradigms that do not rely on cross-site tracking, evolving regulatory frameworks, and the adiption of generative AI on the web~\cite{hercherW3CAdPrivacy2022,chavezUpdatePlansPrivacy2025,builtin-ai}.
%
...
\begin{itemize}
    ...
    \item We identify key open challenges and promising future research directions in web tracking for the community to address in the coming years.
\end{itemize}
